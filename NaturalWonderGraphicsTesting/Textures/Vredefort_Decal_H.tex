...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\NW\Natural Wonders\TM Release2\Vredefort\Vredefort_Decal_H.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3581477311</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Vredefort_Decal_H.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Vredefort_Decal_H"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
