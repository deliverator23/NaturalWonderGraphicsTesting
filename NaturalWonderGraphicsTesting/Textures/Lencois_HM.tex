...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\NW\Natural Wonders\TM Release4\Lencois\Lencois_HM.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>312026609</m_ExportedTime>
	<m_ClassName text="TerrainElementHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Lencois_HM.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Lencois_HM"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
